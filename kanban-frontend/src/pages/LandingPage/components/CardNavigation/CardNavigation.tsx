...
const CardNavigation = ({ setShowLogin, showLogin }: Props) => {
    ...
    return (
      <div className="relative top-2">
        <nav
          ...
          overflow-hidden rounded-t-lg border-2 border-b-0 border-gray-600 bg-white"
        >
          <button
            className="flex skew-x-[-45deg] justify-center border-b-2  
             border-solid border-gray-600 p-4 
            hover:font-bold "
  ...
  return (
    <div className="relative top-2">
      ...
      >
        <div
          className="flex skew-x-[45deg] justify-center border-r-2  
              border-solid border-gray-600 p-4 shadow-[3px_0px_2px_0px] shadow-gray-500 
              "
        >
          <span className="skew-x-[-45deg]">SIGN UP</span>
        </div>
        <button
          className="flex skew-x-[45deg] justify-center 
              border-b-2 border-gray-600 p-4 hover:font-bold"
